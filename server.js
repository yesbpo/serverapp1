...
app.post('/crear-usuario', async (req, res) => {
  try {
    const {usuario, password, email, createdAt, updatedAt, session, type_user, complete_name } = req.body;
    ...
    const nuevoUsuario = {
      id: result.insertId,
      usuario, password, email, createdAt, updatedAt, session, type_user, complete_name
    };
